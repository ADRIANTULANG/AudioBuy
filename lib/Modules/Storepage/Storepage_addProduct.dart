...
class StoreAddProducts extends GetView<StorepageController> {
  const StoreAddProducts({Key? key}) : super(key: key);
          ...
          child: Column(
            children: [
              ...
              Container(
                ...
                child:
                    Obx(() => controller.productFilename.value == 'no-image.jpg'
                        ? IconButton(
                            onPressed: () {
                              controller.getimage();
                            },

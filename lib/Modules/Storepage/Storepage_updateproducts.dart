                    ...
                    () => Container(
                      ...
                      decoration: BoxDecoration(
                        image: controller.productFilename.value == image!
                            ? DecorationImage(
                                fit: BoxFit.cover,
                                image: NetworkImage("$imageEndpoint/${image}"),
                              )
                            : DecorationImage(
                                fit: BoxFit.cover,
                                image: FileImage(
              ...
              Container(
                ...
                child: Column(
                  children: [
                    ...
                    SizedBox(
                      height: sizer.height(height: 19, context: context),
                    ),
                    // Container(
                    //   height: sizer.height(height: 15, context: context),
                    //   width: sizer.width(width: 100, context: context),
                    ...
                    // ),
                    Obx(
                      () => controller.isLoadingUpdatingProduct.value == true
                          ? Center(
                              child: SpinKitThreeBounce(
                                color: Colors.black,
                                size:
                                    sizer.font(fontsize: 30, context: context),
                              ),
                            )
                          : Material(
                              elevation: 5.0,

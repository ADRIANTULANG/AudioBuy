...
class ProviderUpdateProfile extends GetView<ProviderController> {
  const ProviderUpdateProfile({
    Key? key,
    required this.id,
    required this.image,
  }) : super(key: key);
            ...
            child: Column(
              children: [
                    ...
                    Obx(
                      () => Container(
                        ...
                        decoration: BoxDecoration(
                          image: controller.providerFileImageName.value == image
                              ? DecorationImage(
                                  fit: BoxFit.cover,
                                  image:
                ...
                Container(
                  ...
                  child: TextField(
                    controller: controller.providernametext,
                ...
                Container(
                  padding: EdgeInsets.only(
                      ...
                      right: sizer.width(width: 4, context: context)),
                  child: TextField(
                    controller: controller.providerusernametext,
                    decoration: InputDecoration(
                        prefix: Icon(
                          Icons.email,
                          color: Colors.black,
                ...
                Container(
                  padding: EdgeInsets.only(
                      ...
                      right: sizer.width(width: 4, context: context)),
                  child: TextField(
                    controller: controller.providerpasswordtext,
                    decoration: InputDecoration(
                        prefix: Icon(
                          Icons.lock,
                          color: Colors.black,
                ...
                Container(
                  padding: EdgeInsets.only(
                      ...
                      right: sizer.width(width: 4, context: context)),
                  child: TextField(
                    controller: controller.providercontactno,
                    decoration: InputDecoration(
                        prefix: Icon(
                          Icons.phone,
                          color: Colors.black,
                  ...
                  child: Material(
                    ...
                    child: Ink(
                      ...
                      child: MaterialButton(
                        ...
                        child: Text("Update Service Provider Account",
